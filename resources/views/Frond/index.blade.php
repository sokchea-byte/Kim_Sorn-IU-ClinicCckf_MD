...
<body>
		...
		<header class="header-default">
			<nav class="navbar navbar-expand-lg">
				<div class="container-xl">
					<!-- site logo -->
					<a class="navbar-brand" href="index.html"><img src="{{ asset('frond/images/logo.svg') }}" alt="logo" /></a>
						...
						<div class="post featured-post-lg">
							...
							<a href="blog-single.html">
								<div class="thumb rounded">
									<div class="inner data-bg-image" data-bg-image="{{ asset('frond/images/widgets/photo_2025-10-01_00-46-11 (2).jpg') }}"></div>
								</div>
							</a>
						</div>
								...
								<div aria-labelledby="popular-tab" class="tab-pane fade show active" id="popular"
									...
									<div class="post post-list-sm circle">
										<div class="thumb circle">
											<a href="blog-single.html">
												<div class="inner">
													<img src="{{ asset('frond/images/posts/tabs-1.jpg') }}" alt="post-title" />
												</div>
											</a>
										</div>
										<div class="details clearfix">
									...
									<div class="post post-list-sm circle">
										<div class="thumb circle">
											<a href="blog-single.html">
												<div class="inner">
													<img src="{{ asset('frond/images/posts/tabs-2.jpg') }}" alt="post-title" />
												</div>
											</a>
										</div>
										<div class="details clearfix">
									...
									<div class="post post-list-sm circle">
										<div class="thumb circle">
											<a href="blog-single.html">
												<div class="inner">
													<img src="{{ asset('frond/images/posts/tabs-3.jpg') }}" alt="post-title" />
												</div>
											</a>
										</div>
										<div class="details clearfix">
									...
									<div class="post post-list-sm circle">
										<div class="thumb circle">
											<a href="blog-single.html">
												<div class="inner">
													<img src="{{ asset('frond/images/posts/tabs-4.jpg') }}" alt="post-title" />
												</div>
											</a>
										</div>
										<div class="details clearfix">
				...
				<div class="row gy-4">
					...
					<div class="col-lg-8">
						...
						<div class="section-header">
							...
							<img src="{{ asset('frond/images/wave.svg') }}" class="wave" alt="wave" />
						</div>
								...
								<div class="col-sm-6">
									...
									<div class="post">
										<div class="thumb rounded">
											...
											<a href="blog-single.html">
												<div class="inner">
													<img src="{{ asset('frond/images/posts/editor-lg.jpg') }}" alt="post-title" />
												</div>
											</a>
										</div>
										<ul class="meta list-inline mt-4 mb-0">
											<li class="list-inline-item"><a href="#"><img
														src="{{ asset('frond/images/other/author-sm.png') }}" class="author"
								...
								<div class="col-sm-6">
									...
									<div class="post post-list-sm square">
										<div class="thumb rounded">
											<a href="blog-single.html">
												<div class="inner">
													<img src="{{ asset('frond/images/posts/editor-sm-1.jpg') }}" alt="post-title" />
												</div>
											</a>
										</div>
										<div class="details clearfix">
									...
									<div class="post post-list-sm square">
										<div class="thumb rounded">
											<a href="blog-single.html">
												<div class="inner">
													<img src="{{ asset('frond/images/posts/editor-sm-2.jpg') }}" alt="post-title" />
												</div>
											</a>
										</div>
										<div class="details clearfix">
									...
									<div class="post post-list-sm square">
										<div class="thumb rounded">
											<a href="blog-single.html">
												<div class="inner">
													<img src="{{ asset('frond/images/posts/editor-sm-3.jpg') }}" alt="post-title" />
												</div>
											</a>
										</div>
										<div class="details clearfix">
									...
									<div class="post post-list-sm square">
										<div class="thumb rounded">
											<a href="blog-single.html">
												<div class="inner">
													<img src="{{ asset('frond/images/posts/editor-sm-4.jpg') }}" alt="post-title" />
												</div>
											</a>
										</div>
										<div class="details clearfix">
						...
						<div class="ads-horizontal text-md-center">
							...
							<a href="#">
								<img src="{{ asset('frond/images/ads/ad-750.png') }}" alt="Advertisement" />
							</a>
						</div>
								...
								<div class="col-sm-6">
									...
									<div class="post">
										<div class="thumb rounded">
											...
											<a href="blog-single.html">
												<div class="inner">
													<img src="{{ asset('frond/images/posts/trending-lg-1.jpg') }}" alt="post-title" />
												</div>
											</a>
										</div>
										<ul class="meta list-inline mt-4 mb-0">
									...
									<div class="post post-list-sm square before-seperator">
										<div class="thumb rounded">
											<a href="blog-single.html">
												<div class="inner">
													<img src="{{ asset('frond/images/posts/trending-sm-1.jpg') }}" alt="post-title" />
												</div>
											</a>
										</div>
										<div class="details clearfix">
									...
									<div class="post post-list-sm square before-seperator">
										<div class="thumb rounded">
											<a href="blog-single.html">
												<div class="inner">
													<img src="{{ asset('frond/images/posts/trending-sm-2.jpg') }}" alt="post-title" />
												</div>
											</a>
										</div>
										<div class="details clearfix">
								...
								<div class="col-sm-6">
									...
									<div class="post">
										<div class="thumb rounded">
											...
											<a href="blog-single.html">
												<div class="inner">
													<img src="{{ asset('frond/images/posts/trending-lg-2.jpg') }}" alt="post-title" />
												</div>
											</a>
										</div>
										<ul class="meta list-inline mt-4 mb-0">
			...
			<div class="container-xl">
				...
				<div class="instagram-feed d-flex flex-wrap">
					<div class="insta-item col-sm-2 col-6 col-md-2">
						<a href="#">
							<img src="{{ asset('frond/images/insta/insta-1.jpg') }}" alt="insta-title" />
						</a>
					</div>
					<div class="insta-item col-sm-2 col-6 col-md-2">
						<a href="#">
							<img src="{{ asset('frond/images/insta/insta-2.jpg') }}" alt="insta-title" />
						</a>
					</div>
					<div class="insta-item col-sm-2 col-6 col-md-2">
						<a href="#">
							<img src="{{ asset('frond/images/insta/insta-3.jpg') }}" alt="insta-title" />
						</a>
					</div>
					<div class="insta-item col-sm-2 col-6 col-md-2">
						<a href="#">
							<img src="{{ asset('frond/images/insta/insta-4.jpg') }}" alt="insta-title" />
						</a>
					</div>
					<div class="insta-item col-sm-2 col-6 col-md-2">
						<a href="#">
							<img src="{{ asset('frond/images/insta/insta-5.jpg') }}" alt="insta-title" />
						</a>
					</div>
					<div class="insta-item col-sm-2 col-6 col-md-2">
						<a href="#">
							<img src="{{ asset('frond/images/insta/insta-6.jpg') }}" alt="insta-title" />
						</a>
					</div>
				</div>
			</div>
	...
	<div class="canvas-menu d-flex align-items-end flex-column">
		...
		<!-- logo -->
		<div class="logo">
			<img src="{{ asset('frond/images/logo.svg') }}" alt="Katen" />
		</div>
